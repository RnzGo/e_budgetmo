...
export default function HomeScreen({ navigation }) {
  ...
  const [financialData, setFinancialData] = useState({
    income: 100000,    // Actual income amount in pesos
    expense: 60000,   // Actual expense amount in pesos
    balance: 55000,   // Current balance
  });
  ...
  const data = [
    { percentage: incomePercentage, value: financialData.income, label: 'Income', color: '#71c45a' },
    { percentage: expensePercentage, value: financialData.expense, label: 'Expenses', color: '#eb4d4b' }
  ];
    ...
    <View style={styles.container}>
      ...
      <View style={styles.topContent}>
        ...
        <View style={styles.chartContainer}>
          ...
          <View style={styles.chartCenterText}>
            <Text style={[styles.centerPercentage, styles.incomePercentage]}>
              {user.income}%
            </Text>
            <Text style={styles.centerLabel}>Income</Text>
            <Text style={[styles.centerPercentage, styles.expensePercentage]}>
              {user.expense}%
            </Text>
      ...
      <View style={styles.bottomSection}>
        ...
        <View style={styles.shortcuts}>
          {/* Add Income - Green */}
          <TouchableOpacity style={[styles.shortcutButton, styles.incomeButton]}>
            <MaterialIcons name="add-circle" size={28} color="#FFFFFF" />
            <Text style={[styles.shortcutText, styles.incomeText]}>Add Income</Text>
          </TouchableOpacity>
          
          {/* Add Expenses - Red */}
          <TouchableOpacity style={[styles.shortcutButton, styles.expenseButton]}>
